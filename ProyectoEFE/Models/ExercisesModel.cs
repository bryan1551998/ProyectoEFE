namespace ProyectoEFE.Models
{
    public class ExercisesModel
    {
        ...
        //Constructors
        public ExercisesModel(int id_exercise, int fk_topic, string name_exercise, string description_exercise, string solution_exercise, string number_exercise)
        {
        ...
        public ExercisesModel(int fk_topic, string name_exercise, string description_exercise, string solution_exercise, string number_exercise)
        {
            this.Fk_topic = fk_topic;
            this.Name_exercise = name_exercise;
            this.Description_exercise = description_exercise;
        ...
        public ExercisesModel(string name_exercise, string description_exercise, string solution_exercise, string number_exercise)
        {
            this.Name_exercise = name_exercise;
            this.Description_exercise = description_exercise;
            this.Solution_exercise = solution_exercise;
