namespace ProyectoEFE.Models
{
    public class TopicsModel
    {
        ...
        //Constructors
        public TopicsModel(int id_topic, int fk_curs, string name_topic, string description_topic)
        {
        ...
        public TopicsModel(int fk_curs, string name_topic, string description_topic)
        {
            this.Fk_curs = fk_curs;
            this.Name_topic = name_topic;
            this.Description_topic = description_topic;
        ...
        public TopicsModel(string name_topic, string description_topic)
        {
            this.Name_topic = name_topic;
            this.Description_topic = description_topic;
